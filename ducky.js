...
setInterval(() => {
  ...
  function createDuck() {
    let Anotherduck = document.createElement('div');
    Anotherduck.className = "duck";
    randomPosition(Anotherduck)
    body.append(Anotherduck);
    setInterval(() => {
      Anotherduck.classList.toggle("flap");
    }, 250)
    setInterval(() => {
      moveDuck(Anotherduck);
    }, 1000)
    return createDuck 
  }
  ...
  allDucks.forEach(function (killed){
    killed.addEventListener('click', () => {
    killed.classList.add('shot');
